...
void main() {
    ...
    // // BEF_CLOCKWISE_ROTATE_0 = 0, // 图像不需要旋转，图像中的人脸为正脸
    // // BEF_CLOCKWISE_ROTATE_90 = 1, // 图像需要顺时针旋转90度，使图像中的人脸为正
    // // BEF_CLOCKWISE_ROTATE_180 = 2, // 图像需要顺时针旋转180度，使图像中的人脸为正
    // // BEF_CLOCKWISE_ROTATE_270 = 3  // 图像需要顺时针旋转270度，使图像中的人脸为正
	// float angle = radians(rotate * 90.);
