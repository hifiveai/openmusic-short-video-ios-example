...
@implementation DVEAnimationItemCell
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        if([DVEUILayout dve_alignmentWithName:DVEUILayoutAnimationItemTextPosition] == DVEUILayoutAlignmentBottom){
