...
@implementation DVERegulateCategoryUIConfiguration
...
@implementation DVERegulatePickerUIConfiguration
...
- (NSDictionary<NSString*,Class> *)stickerItemCellKeyClass {
    return @{NSStringFromClass([DVERegulateItem class]) : [DVERegulateItem class]};
}

///根据model返回Cell的identified
- (NSString *_Nonnull)identifiedForModel:(DVEEffectValue*_Nonnull)model {
    return NSStringFromClass([DVERegulateItem class]);
}
...
@interface DVERegulateUIConfiguration ()
...
@implementation DVERegulateUIConfiguration

- (id<DVEPickerEffectUIConfigurationProtocol>)effectUIConfig {
    if (!_effectUIConfig) {
        _effectUIConfig = [[DVERegulatePickerUIConfiguration alloc] init];
    }
...
- (id<DVEPickerCategoryUIConfigurationProtocol>)categoryUIConfig {
    if (!_categoryUIConfig) {
        _categoryUIConfig = [[DVERegulateCategoryUIConfiguration alloc] init];
    }
