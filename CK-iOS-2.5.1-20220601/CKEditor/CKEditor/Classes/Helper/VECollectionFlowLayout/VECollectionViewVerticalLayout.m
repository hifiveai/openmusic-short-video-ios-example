//
//  VECollectionViewVerticalLayout.m
//  VECollectionView
//
...
@interface VECollectionViewVerticalLayout ()

@end

@implementation VECollectionViewVerticalLayout
...
- (void)prepareLayout {
    ...
    for (int index= 0; index<sectionCount; index++) {
        ...
        if (headerH > 0) {
            ...
            VECollectionViewLayoutAttributes* headerAttr = [VECollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:UICollectionElementKindSectionHeader withIndexPath:headerIndexPath];
        ...
        if (itemCount > 0) {
            ...
            for (int i=0; i<itemCount; i++) {
                ...
                VECollectionViewLayoutAttributes *attributes = [VECollectionViewLayoutAttributes layoutAttributesForCellWithIndexPath:indexPath];
...
#pragma mark 标签布局处理
                    case LabelLayout: {
                        ...
                        if(preRow >= 0){
                            if(i > 0) {
                                VECollectionViewLayoutAttributes *preAttr = self.attributesArray[preRow];
                            ...
                            if ((totalPercent+percent) >= 1.0) {
                                if ((totalPercent+percent) < 1.1) {
                                    ...
                                    for (NSInteger i=0; i<arrayOfPercent.count; i++) {
                                        ...
                                        VECollectionViewLayoutAttributes *newAttributes = dic[@"item"];
                                        CGFloat itemX = 0.0f;
                                        if (i==0) {
                                            itemX = edgeInsets.left;
                                        } else {
                                            VECollectionViewLayoutAttributes *preAttr = arrayOfPercent[i-1][@"item"];
                                    ...
                                    for (NSInteger i=0; i<arrayOfPercent.count; i++) {
                                        NSDictionary* dic = arrayOfPercent[i];
                                        VECollectionViewLayoutAttributes *item = dic[@"item"];
                                    ...
                                    if (arrayOfPercent.count > 0) {
                                        for (int i=0; i<arrayOfPercent.count; i++) {
                                            NSDictionary* dic = arrayOfPercent[i];
                                            VECollectionViewLayoutAttributes* attr = dic[@"item"];
                                ...
                                VECollectionViewLayoutAttributes *lastAttributesForPercent = lastDicForPercent[@"item"];
                        ...
                        if (arrayOfFill.count == 0) {
                            ...
                            for (NSNumber* yFill in arrayYOfFill) {
                                for (NSNumber* xFill in arrayXOfFill) {
                                    ...
                                    for (VECollectionViewLayoutAttributes* attr in arrayOfFill) {
...
#pragma mark 绝对定位布局处理
                ...
                if (self.layoutType == ClosedLayout) {
                    ...
                    if (i==itemCount-1) {
                        for (VECollectionViewLayoutAttributes* attr in arrayOfAbsolute) {
        ...
        if (footerH > 0) {
            ...
            VECollectionViewLayoutAttributes *footerAttr = [VECollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:UICollectionElementKindSectionFooter withIndexPath:footerIndexPath];
...
//    for (VECollectionViewLayoutAttributes* attr in self.attributesArray) {
