//
//  VECollectionViewBaseFlowLayout.h
//  VECollectionView
//
...
@class VECollectionViewBaseFlowLayout;
@protocol  VECollectionViewBaseFlowLayoutDelegate <NSObject, UICollectionViewDelegateFlowLayout>
@optional
...
/***
 ...
 纵向布局请调用 #import "VECollectionViewVerticalLayout.h"
 横向布局请调用 #import "VECollectionViewHorzontalLayout.h"
 ***/
@interface VECollectionViewBaseFlowLayout : UICollectionViewFlowLayout

@property (nonatomic,weak) id<VECollectionViewBaseFlowLayoutDelegate> delegate;
